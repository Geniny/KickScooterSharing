    ...
    public partial class products : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScooterModel", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecondName", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScooterModelId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scooter", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Scooter_ScooterModel_ScooterModelId",
                        column: x => x.ScooterModelId,
                        principalTable: "ScooterModel",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondNameId = table.Column<int>(nullable: true),
                    FirstNameId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_FirstName_FirstNameId",
                        column: x => x.FirstNameId,
                        principalTable: "FirstName",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_SecondName_SecondNameId",
                        column: x => x.SecondNameId,
                        principalTable: "SecondName",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Scooter_ScooterId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_Tariff_TariffId",
                        column: x => x.TariffId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_FirstNameId",
                table: "AspNetUsers",
                column: "FirstNameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SecondNameId",
                table: "AspNetUsers",
                column: "SecondNameId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scooter_ScooterModelId",
                table: "Scooter",
                column: "ScooterModelId");
        }
